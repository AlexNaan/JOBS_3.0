...
class Doc_and_stage():
	...
	def __init__(self, default_settings):
        ...
        self.URL_1C         = default_settings.URL_1C
	...
	def remote_delete_objects(self):
		...
		r = requests.post('http://'+ self.IP_HOST_1C + self.URL_1C + '/get_list_number_doc',auth=(self.LOGIN_1C,self.PASSWORD_1C)) 
		Data = r.content 
		if Data:
	...
	def load_available_stage(self):
		...
		r = requests.post('http://' + self.IP_HOST_1C + self.URL_1C + '/get_stages',auth=(self.LOGIN_1C,self.PASSWORD_1C)) 
		Data = r.content 
		if Data:
	...
	def load_email_tel(self): 
		...
		for row in select_row:
			...
			r = requests.post('http://' + self.IP_HOST_1C + self.URL_1C + '/info_object',auth=(self.LOGIN_1C,self.PASSWORD_1C),data=payload) 
			Data = r.content 
			if Data:
				dic = json.loads(Data)
	...
	def load_partners(self):
		...
		r = requests.post('http://' + self.IP_HOST_1C + self.URL_1C + '/get_partners',auth=(self.LOGIN_1C,self.PASSWORD_1C)) 
		Data = r.content 
		if Data:
