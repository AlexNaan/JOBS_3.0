...
class Config():
	...
	def __init__(self):
		...
		if self.PATH_LOCAL_DB is None:
			self.ERROR = True
			self.ERROR_TEXT = 'Set param PATH_LOCAL_DB\n'
        ...
        if self.URL_1C is None:
            self.ERROR = True
            self.ERROR_TEXT = self.ERROR_TEXT + 'Set param URL_1C\n'
